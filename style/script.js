...
const messages=[
  "Giáng Sinh này, có đứa ở một mình lêu lêu ❤️",
  "Chúc cưng một Giáng Sinh thật ấm áp và đầy yêu thương 🎄💖",
  "Mong mỗi ngày của bà đều rực rỡ như những ánh đèn Giáng Sinh ✨",
  "Cảm ơn bà vì đã làm trò hề mỗi ngày (and spamming tiktoks) ",
  "Liên quân không? 🎁"
];
